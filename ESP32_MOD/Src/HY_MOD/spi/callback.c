...
void IRAM_ATTR spi_done_cb(spi_slave_transaction_t *trans)
{
    SpiParametar *spi = (SpiParametar*)trans->user;
    ...
    vTaskNotifyGiveFromISR(spi->txrx, &xHigherPriorityTaskWoken);
